...
<!-- Start Bradcaump area -->
							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="update_profile()" id="btn_submit">Update Username</button>
										
									</div>
								</form>
								<div  style="margin-top:50px;">
										<a  class="fr__btn" href="my_order.php" id="btn_submit">My Orders</a>
								</div>
		...
		function update_password(){
			...
			if(new_password!='' && confirm_new_password!='' && new_password!=confirm_new_password){
				jQuery('#confirm_new_password_error').html('Passwords do not match..');
				is_error='yes';
			}
			...
			if(is_error==''){
				...
				jQuery.ajax({
					...
					success:function(result){
						...
						//the below code is responsible for resetting the form on successful submission
