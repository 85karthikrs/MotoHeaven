...
//if someone enters special characters in url then they will be redirected to the home page
        ...
        <section class="htc__product__grid bg__white ptb--100">
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
										...
										<div class="col-md-4 col-lg-3 col-sm-4 col-xs-6" style="height:370px !important; ">
											<div class="category">
												...
												<div class="fr__product__inner" style="margin-bottom:40px !important;">
													<h4><a href="product-details.html"><?php echo $list['name']?></a></h4>
													<ul class="fr__pro__prize">
														<li class="old__prize"><strike><?php echo $list['mrp']?></strike></li>
														<li><?php echo "₹".$list['price']?></li><br/>
													</ul>
												</div>
					...
					<?php } else { 
						echo "<h3>Currently There are no products here...</h3>";
					} ?>
