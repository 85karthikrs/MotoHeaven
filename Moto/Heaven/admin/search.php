...
<div class="body__overlay"></div>
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(slides/a3.jpg) no-repeat scroll center center / cover ;">
        ...
        <section class="htc__product__grid bg__white ptb--100">
            <div class="container">
                <div class="row">
					...
					<?php } else { 
						echo "<h2> No products found with name ' $str ' ..................</h2>";
					} ?>
