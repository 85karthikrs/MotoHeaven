            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form action="#"> 
							<?php $check_user=mysqli_num_rows($res);
							if($check_user>0){ ?>
                                    ...
                                    <tbody>
										...
										?>
											<tr>
												...
												<td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $row['pid']?>','add')">Add to Cart</a><br><a href="wishlist.php?wishlist_id=<?php echo $row['id']?>" onclick="manage_cart('<?php echo $row['pid']?>','add')">Move To Cart</a></td>
											</tr>
											<?php } ?>
                                    </tbody>
                                </table>
                            </div>
							<?php }else{ echo "<h2 style='padding-bottom:100px;'>Your wishlist is empty....</h2>";}?>
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
