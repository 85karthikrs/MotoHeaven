                            ...
                            <form action="#">
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th class="product-stock-stauts">Order ID</th>
                                        ...
                                        <tbody>
											...
											?>
                                            <tr>
												<td class="product__action"><a title="Click here for order details" style="border:2px solid black;margin:5px;" href="my_order_details.php?id=<?php echo $row['id']?>"> <?php echo $row['id']?><span> - Order Details</span></a>
												<br/>
												<a style="border:2px solid black;margin:5px; padding:5px;" href="order_pdf.php?id=<?php echo $row['id']?>"> Order-PDF</a>
												</td>
